...
> End-to-end ML system with explainability, bias analysis, and a deployed Streamlit web application.

* Built a complete machine learning pipeline to predict campus placement outcomes
* Integrated **SHAP explainability** to provide transparent model predictions
* Performed **bias analysis** across demographic groups
* Deployed as an interactive **Streamlit** application

**Stack:** Python · Scikit-learn · SHAP · Streamlit · Jupyter

🔗 **Live Demo:** https://placifyx-19.streamlit.app/

🔗 **Repository:** https://github.com/dikshasehrawat/PlacifyX
...
🔗 **Repository:** https://github.com/dikshasehrawat/Medical-Chatbot-Generative-AI
...
🔗 **Live Demo:** https://real-estate-theta-pearl.vercel.app

🔗 **Repository:** https://github.com/dikshasehrawat/Real-Estate
